...
gulp.task('webpack', async () => {
    await buildWebPackForDevOrProduction('./extension.webpack.config.js', 'extension');
    await buildWebPackForDevOrProduction('./extension-browser.webpack.config.js', 'browser');
});
