...
class CreateEnvironmentProviders {
    ...
    public add(provider: CreateEnvironmentProvider, toTopOfList: boolean) {
        // Removed isEnvProviderEnabled check as it depends on deleted erdos/createEnvApi
...
export async function registerCreateEnvironmentFeatures(
    ...
    disposables.push(
        registerCommand(
            ...
            async (
                ...
                if (useEnvExtension()) {
                    ...
                    // Removed pythonRuntimeManager.selectLanguageRuntimeFromPath as it depends on deleted erdos/manager
                    return env;
                }
                return undefined;
            },
        ...
        // Removed Get_Create_Environment_Providers and Create_Environment_And_Register commands
        // as they depend on deleted erdos/createEnvApi and erdos/manager
        registerCommand(
        ...
        // Removed Is_Global_Python command as it depends on deleted erdos/createEnvApi
