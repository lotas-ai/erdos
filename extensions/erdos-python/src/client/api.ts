...
import { RuntimeSession } from './erdos/session';
...
export function buildApi(
    ...
    (api as any).erdos = {
        createRuntimeSession:
            (runtimeMetadata: any, sessionMetadata: any, sessionName?: any, kernelSpec?: any) =>
                new RuntimeSession(runtimeMetadata, sessionMetadata, sessionName, kernelSpec),
    };
    return api;
}
