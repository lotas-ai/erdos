...
// Note: Kernel management is now handled by the erdos-kernel-manager extension
// which auto-activates and manages kernels via WebSocket instead of the old
// supervisor/kernel-bridge architecture.
