...
export const Context = {
	...
	InTabSuggestContext: new RawContextKey<boolean>('inTabSuggestContext', false, localize('inTabSuggestContext', "Whether the cursor is in a context where tab should trigger suggestions")),
};
