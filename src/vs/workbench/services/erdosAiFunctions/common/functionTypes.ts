 ...
 * Licensed under the AGPL-3.0 License. See License.txt in the project root for license information. See LICENSE file in the project root for details.
 */
...
export interface CallContext {
	...
	jupytextService: {
		...
		getNotebookJupytextOptions(notebookContent: string, fileUri?: any): { extension: string; format_name: string };
	};
	fileResolverService: {
