...
import { areWebviewContentOptionsEqual, IWebviewElement, WebviewContentOptions, WebviewContentPurpose, WebviewExtensionDescription, WebviewInitInfo, WebviewMessageReceivedEvent, WebviewOptions } from './webview.js';
...
export class WebviewElement extends Disposable implements IWebviewElement, WebviewFindDelegate {
	...
	private _createElement(options: WebviewOptions, _contentOptions: WebviewContentOptions) {
		...
		// Enable text selection for webview views (like help pane)
		if (options.purpose === WebviewContentPurpose.WebviewView) {
