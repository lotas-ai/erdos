											...
											<div className="setting-item-contents">
												...
												<div className="setting-item-value setting-item-toggle-value">
													...
													<span className="toggle-label">
														{securityMode === 'secure' ? 'Secure' : 'Improve Erdos for everyone'}
													</span>
												</div>
											</div>
											<div className="setting-item-description">
												On secure mode, no analytics are collected and zero data is retained by the model providers. This must be used for any sensitive data like PHI. On "Improve Erdos for everyone," user analytics are collected to improve the experience. Still, zero data is retained by the model providers. Your current mode is: {securityMode === 'secure' ? 'Secure' : 'Improve Erdos for everyone'}
											</div>
										</div>
