...
import { IExtHostProxy } from '../node/extHostProxy.js';
...
export function createApiFactoryAndRegisterActors(accessor: ServicesAccessor): IExtensionApiFactory {
	...
	const extHostRuntime = accessor.get(IExtHostRuntime);
	...
	rpcProtocol.set(ExtHostContext.ExtHostRuntime, extHostRuntime);
	...
	rpcProtocol.set(ExtHostContext.ExtHostRuntime, accessor.get(IExtHostRuntime));

	// Register bash parser commands
	registerBashParserCommands(extHostCommands, extHostBashParser);

	rpcProtocol.set(ExtHostContext.ExtHostMcp, accessor.get(IExtHostMpcService));
	rpcProtocol.set(ExtHostContext.ExtHostProxy, accessor.get(IExtHostProxy));
